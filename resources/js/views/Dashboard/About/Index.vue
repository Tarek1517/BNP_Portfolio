...
const handeleinActive = async (id) => {
    const response = await sendRequest({
        method: "get",
        url: `/v1/about-inactive-status/${id}`,
    });
    if (response) {
        await getAboutContent();
    ...
    <GuestLayout>
        <section class="p-4 sm:p-6">
            ...
            >
                ...
                <RouterLink to="/admin/create-about" class="w-full sm:w-auto">
                    <button
            ...
            <div class="block sm:hidden space-y-4">
                ...
                >
                            ...
                            <div class="flex items-start justify-between">
                                ...
                                <div>
                                    <div
                                        v-if="
                                            about?.key_features &&
                                            Array.isArray(about.key_features) &&
                                            about.key_features.length > 0
                                        "
                    ...
                    >
                        ...
                        <button
                            v-if="about?.status == 1"
                            @click="handeleinActive(about?.id)"
                    ...
                    <table class="w-full text-sm text-left text-gray-700">
                        ...
                        >
                            <tr>
                                <th
                                    scope="col"
                                    class="px-4 py-3 sm:px-6 sm:py-3"
                                >
                                    Image
                                </th>
                                ...
                                <td class="px-6 py-4">
                                    <div class="font-medium text-gray-900">
                                        <img class="w-12 h-12 sm:w-16 sm:h-16 object-cover rounded-lg"
                                            :src="about?.image" :alt="about?.name">
                                    </div>
                                </td>
                                <!-- Name -->
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4 align-top">
                                    ...
                                    >
                                        <div
                                            ...
                                            :key="index"
                                            class="text-black flex flex-col gap-1 text-sm"
                                        >
                                            <span class="text-xs">
                                                • {{ item.year }} -
                                                {{ item.title }}
