...
const onSubmit = async (id) => {
    ...
    if (response?.data) {
        toast.success("Serve Updated Successfully", {
            autoclose: 1000,
            theme: "dark",
        });
            ...
            <div class="flex flex-wrap -mx-2">
                ...
                <div class="w-full sm:w-1/2 mb-4 sm:mb-5 px-2">
                    <div class="flex flex-col gap-1">
                        ...
                        <input type="text"
                            ...
                            v-model="form.title" placeholder="Enter Serve title" />
                    </div>
                </div>
                ...
                <div class="w-full sm:w-1/2 mb-4 sm:mb-5 px-2">
                    <div class="flex flex-col gap-1">
                        ...
                        <input type="text"
                            class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all duration-200"
                            v-model="form.sub_title" placeholder="Enter Serve sub title" />
                    </div>
                </div>
                ...
                <div class="w-full sm:w-1/2 mb-4 sm:mb-5 px-2">
                    <div class="flex flex-col gap-1">
                        <label for="serve_icon" class="text-sm mb-1 sm:mb-2 font-medium text-gray-700">Icon
                            Class</label>
                        <input type="text"
                            class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all duration-200"
                            v-model="form.serve_icon" placeholder="e.g., fas fa-users, mdi-account, etc." />
                    ...
                    <div class="flex items-end flex-wrap -mt-4">
                        <div v-for="(item, index) in form.key_features" class="w-4/5 pr-4 mt-4 flex items-center">
                            <input type="text" class="border border-gray-300 p-2 w-full text-sm rounded-lg"
                                placeholder="Enter Key Features" v-model="item.name" />
