    ...
    try {
        ...
        if (response) {
            ...
            form.value = {
                ...
                utr_number: customer.value.utr_number || null,
                company_name: customer.value.company_name || null,
                company_number: customer.value.company_number || null,
                address_line: customer.value.address_line || null,
            };
        }
    } catch (error) {
            ...
            <Container class="pb-10 max-w-xl mt-10">
                            ...
                            >
                                <div class="p-4">
                                    <RouterLink
                                        ...
                                        class="absolute top-0 right-0 block px-2 py-1 text-xs rounded m-2 bg-primary text-white hover:bg-secondary"
                                        >Invoice</RouterLink
                                    >
                                </div>
                                ...
                                <div class="p-4">
                                    ...
                                    <h4
                                        class="text-base text-black font-medium mb-2"
                                    >
                ...
                <div v-if="activeTab == 2">
                    ...
                    >
                        ...
                        <div class="">
                            <label for="name" class="block pb-1 text-xs"
                                >Companey Number</label
                            >
                            <input
                                type="text"
                                name="Companey number"
                                id="number"
                        ...
                        <div class="">
                            <label for="name" class="block pb-1 text-xs"
                                >UTR Number (For sole trader )</label
                            >
                            <input
                                type="text"
                                name="Companey number"
